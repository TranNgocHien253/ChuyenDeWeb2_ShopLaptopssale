                ...
                <div class="popup-layout">
                    <div class="form-section">
                        <div class="form-group">
                            <label>Liên Hệ</label>
                            <input type="text" class="form-input" placeholder="Họ Và Tên" id="name" required autofocus pattern="[A-Za-zÀ-ỹ\s]+" oninput="this.value = this.value.replace(/[^A-Za-zÀ-ỹ\s]/g, '');">
                            <input type="tel" class="form-input" placeholder="Số Điện Thoại" id="phone" maxlength="11" pattern="[0-9]*" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 11);">
